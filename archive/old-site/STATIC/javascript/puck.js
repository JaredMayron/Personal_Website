...
(function (global) {
  ...
  function build(triangles, startPuck, pucksize, canvas) {
    ...
    triangles.forEach(function (triangle) {
      ...
      //Add adjacent edges for each of the vertices (each vertex starts with 2, but it can build up depending on the structure)
  ...
  //Given, a set of triangles with vertices with exactly 1 of those vertices being a start vertex
